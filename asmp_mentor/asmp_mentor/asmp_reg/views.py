...
def mentorReg(request):
    ...
    if request.method == 'POST':
        ...
        registration = Registration(firstname=firstname or "NA", lastname=lastname or "NA", email=email or "NA", department=department or "NA", department_other=department_other or "NA",
                                    ...
                                    contact=contact or "NA", designation=designation or "NA", company_name=company_name or "NA", work_profile=work_profile or "NA", dept_mentees=dept_mentees or "NA", availability=availability)
